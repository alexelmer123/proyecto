...
CREATE TABLE IF NOT EXISTS `productos` (
    ...
    `ancho`         DECIMAL(10,2) NULL,    -- mm
    `alto`          DECIMAL(10,2) NULL,    -- mm
    `grosor`        DECIMAL(10,2) NULL,    -- mm
...
-- Usuario admin: se crea desde database/install.php (hash real de bcrypt).
-- NO insertar manualmente aquí: ejecuta `php database/install.php`
-- después de cargar este schema para sembrar el admin demo.
...
VALUES
    ('VID-00001', 'Vidrio templado claro 10mm',  'Lámina estándar 1.83 × 2.44 m', 1, 1,
     'lámina', 1830, 2440, 10,  220000, 380000,  18, 5),
    ('VID-00002', 'Vidrio laminado 6+6 mm',      'Doble capa con PVB transparente', 2, 1,
     'lámina', 1830, 2440, 12,  280000, 460000,   3, 4),
    ('VID-00003', 'Espejo plata 4mm',            'Lámina 2.40 × 1.50 m, canto pulido', 3, 2,
     'lámina', 2400, 1500,  4,  130000, 230000,  22, 6),
    ('VID-00004', 'Cristal serigrafiado azul',   'Vidrio templado con tinta azul', 4, 3,
     'lámina', 1830, 2440,  8,  260000, 420000,   5, 6),
    ('VID-00005', 'Sellador de silicona neutra', 'Cartucho 300 ml, color claro', 5, 1,
     'u',     NULL,  NULL, NULL,   18000,  32000, 60, 12),
    ('VID-00006', 'Ventosa doble 8"',            'Para manipulación de láminas pesadas', 5, 2,
     'u',     NULL,  NULL, NULL,   95000, 160000,  4, 3);

-- Movimientos iniciales coherentes con el stock cargado (entradas de inventario)
INSERT INTO `movimientos`
    (`producto_id`, `tipo`, `cantidad`, `stock_anterior`, `stock_nuevo`,
     `usuario_id`, `proveedor_id`, `observacion`)
VALUES
    (1, 'entrada', 18, 0, 18, 1, 1, 'Carga inicial de inventario'),
    (2, 'entrada',  3, 0,  3, 1, 1, 'Carga inicial — pedido parcial'),
    (3, 'entrada', 22, 0, 22, 1, 2, 'Carga inicial'),
    (4, 'entrada',  5, 0,  5, 1, 3, 'Carga inicial'),
    (5, 'entrada', 60, 0, 60, 1, 1, 'Compra silicona x60'),
    (6, 'entrada',  4, 0,  4, 1, 2, 'Carga inicial — herramienta');
