...
<form method="post" action="<?= BASE_URL ?>/producto/crear" enctype="multipart/form-data" class="form form--card" novalidate>
    <fieldset class="form__group">
        <legend class="form__legend">Identidad</legend>
        <div class="form__row form__row--2">
            <label class="field">
                <span class="field__label">Código <small>(opcional, se autogenera)</small></span>
                <input class="field__input mono" name="codigo" value="<?= $h($form['codigo'] ?? '') ?>"
                       placeholder="VID-00042">
                <?= $err('codigo') ?>
            </label>
            <label class="field">
    ...
    <fieldset class="form__group">
        ...
        <label class="field">
            <span class="field__label">Subir imagen <small>(JPG/PNG/WebP, máx. 4 MB)</small></span>
